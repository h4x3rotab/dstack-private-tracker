 ...
 */
 ...
 //TODO: NEED TEE ATTESTATION TO BE ADDED TO THE CONTRACT
contract ReputationFactory {

    // Event to be emitted when a new Reputation is created for easier off-chain tracking.
    event ReputationCreated(address newReputationAddress, address owner, address referrer);
     ...
     */
    function createReputation(address _referrerReputation) public returns (address) {
        ...
        emit ReputationCreated(address(newReputation), msg.sender, _referrerReputation);
